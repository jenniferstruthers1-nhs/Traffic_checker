# Code of conduct for `rap_website_traffic`

Contributors to this repository hosted by `nhsengland` are expected to follow the
...
- "Project", we mean this `rap_website_traffic` GitHub repository;
- "Maintainer", we mean the `nhsengland` organisation owners; and
- "Leadership", we mean both `nhsengland` organisation owners, line managers, and other
  leadership within the NHS England.
...
[jennifer.struthers1@nhs.net][email-address]. All complaints will be
...
[email-address]: mailto:jennifer.struthers1@nhs.net
