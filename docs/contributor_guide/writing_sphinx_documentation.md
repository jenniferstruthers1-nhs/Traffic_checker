...
Let us say that `rap_website_traffic/__init__.py` has functions called `hello` and `world` imported
into it, and both have docstrings. To automatically generate docstring documentation,
create a ReST file, and add the following line to reference the `rap_website_traffic` module:

```rest
.. currentmodule:: rap_website_traffic
```
...
Let us say that `rap_website_traffic/__init__.py` has functions called `hello` and `world` imported
into it, and both have docstrings. To automatically generate docstring documentation,
create a Markdown file, and add the following line to reference the `rap_website_traffic` module:
